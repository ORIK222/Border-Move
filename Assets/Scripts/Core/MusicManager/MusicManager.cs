...
public class MusicManager : MonoBehaviour
{
    ...
    private static float _sfxVolume = 0.3f;
    ...
    public static float CROSSFADE_TIME = 4.0f;
    // The music player game object
    private static GameObject curr_me = null;
    // current played music game object
    private static MusicPlayer curr_mp = null;
    // current played music player
    private static GameObject free_me = null;
    // free music game object
    private static MusicPlayer free_mp = null;
    // free music player
    ...
    private static void AddSoundToPlayed(string name, float delay)
    {
        ...
        LeanTween.delayedCall(obj, delay, () =>
        {
            OnSoundEnded(name);
        });
    }
